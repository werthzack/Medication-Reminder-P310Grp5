...
function addMedication() {
	...
	notifyButton.addEventListener("click", () =>
		showNotification(nameParagraph.value, "It's time to take your medication")
	);
	...
	deleteButton.addEventListener("click", () =>
		deleteMedication(medicationItem.id)
	);
...
function editMedication(itemId) {
	...
	const medicationName = prompt(
		"Enter the updated medication name:",
		medicationDetails.children[0].textContent.split(": ")[1]
	);
	const medicationTime = prompt(
		"Enter the updated medication time (Hh:mm):",
		medicationDetails.children[1].textContent.split(": ")[1]
	);
	const medicationDuration = prompt(
		"Enter the updated medication duration (in days):",
		medicationDetails.children[2].textContent.split(": ")[1]
	);
